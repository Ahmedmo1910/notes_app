        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                CreateDifferentNotes(iconPath: 'assets/icons/event.svg', text: 'Event'),
                CreateDifferentNotes(iconPath: 'assets/icons/note_book.svg', text: 'Notebook'),
                CreateDifferentNotes(iconPath: 'assets/icons/mic.svg', text: 'Audio'),
                CreateDifferentNotes(iconPath: 'assets/icons/camera.svg', text: 'Camera')
              ],
            )
          ],
        ),
